...
PRIMITIVES['bb-info-pause-world'] =
    new PrimProc('bb-info-pause-world',
		 1,
		 false, false,
		 function(bbInfo) {
		 	check(bbInfo, types.isBigBangInfo, 'bb-info-pause-world', 'bb-info', 1);
			return types.bbInfoPauseWorld(bbInfo);
		 });
