...
(function() {
	...
	BigBang.prototype.initConfigStartupArg = function() {
		...
		var schemePauseWorld =
			new types.PrimProc('pause-world', 1, false, false,
				function(thunk) {
					helpers.check(thunk, helpers.procArityContains(0),
						      'pause-world', 'procedure (arity 0)', 1);
					return PAUSE(function(newCaller, newOnSuccess, newOnFail) {
						that.pause(function() {
							newCaller(thunk,
								  [],
		...
		this.configStartupArg = types.makeBigBangInfo(schemeChangeWorld,
							      helpers.wrapJsValue(this.toplevelNode),
							      schemePauseWorld,
