...
(function() {
	...
	var BigBang = function(aState, caller) {
		...
		this.beforeCallPause = function(k) {
//			console.log('in beforeCallPause');
			that.state.removeBeforeCallListener(that.beforeCallPause);
			that.state.removeAfterCallListener(that.afterCallRestart);
			that.pauseUserConfigs(k);
		};
		this.afterCallRestart = function(k) {
//			console.log('in afterCallRestart');
			that.restartUserConfigs(function() {
				that.state.addBeforeCallListener(that.beforeCallPause);
				that.state.addAfterCallListener(that.afterCallRestart);
				k();
			});
		};
