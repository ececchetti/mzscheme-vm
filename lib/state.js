...
State.prototype.save = function() {
    return { v: this.v,
	     ...
	     onFail: this.onFail,
//	     beforeCallListeners: this.beforeCallListeners,
//	     afterCallListeners: this.afterCallListeners,
	     noBlockingCalls: this.noBlockingCalls };
};
...
//    this.beforeCallListeners = params.beforeCallListeners;
//    this.afterCallListeners = params.afterCallListeners;
    this.noBlockingCalls = params.noBlockingCalls;
};


//State.prototype.addBeforeCallListener = function(f) {
//	this.beforeCallListeners.push(f);
//};
//
//State.prototype.removeBeforeCallListener = function(f) {
//	var index = this.beforeCallListeners.indexOf(f);
//	if ( index != -1 ) {
//		this.beforeCallListeners.splice(index, 1);
//	}
//};
//
//State.prototype.addAfterCallListener = function(f) {
//	this.afterCallListeners.push(f);
//};
//
//State.prototype.removeAfterCallListener = function(f) {
//	var index = this.afterCallListeners.indexOf(f);
//	if ( index != -1 ) {
//		this.afterCallListeners.splice(index, 1);
//	}
//};
